                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('booking') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row my-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="hidden" name="rooms_id" value="{{ $rooms['id'] }}">
                                    <input type="text" class="form-control" readonly value="{{ $rooms['no_room'] }}">
                                </div>
                            </div>
                            <div class="row my-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Price</label>
                                <div class="col-sm-10">
                                    <input type="hidden" name="cost" value="{{ $rooms['price'] }}">
                                    <input type="text" class="form-control" readonly
                                        value="{{ 'Rp ' . number_format($rooms['price'], 0, ',', '.') }}">
                                </div>
                            </div>
                            <div class="row my-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="file" id="formFile" name="file_payment"
