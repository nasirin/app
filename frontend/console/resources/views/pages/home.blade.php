                ...
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        ...
                        ">
                                    ...
                                    <div class="ps-3">
                                        ...
                                        <span
                                            class="small pt-1 fw-bold">{{ 'Rp ' . number_format($summary['kebutuhan']['totalPengeluaran'], 0, ',', '.') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card recent-sales">
                            <div class="filter">
                                <a class="icon" href="/template/#" data-bs-toggle="dropdown"><i
                                        ...
                                        @if ($newBooking)
                                            @foreach ($newBooking as $key => $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/booking/{{ $data['id'] }}"
                                                            class="text-primary">{{ $data['room']['no_room'] }}</a>
                                                    </td>
                                                    <td>{{ $data['check_in'] }}</td>
